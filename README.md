...
A colorful VS Code theme hub built around fast mood switching: orange-first classics, seasonal palettes, holiday themes, and gaming-inspired looks. It started with **All Orange** and grew into a 30-theme pack.
...
| Pack | Themes |
| --- | --- |
| Orange Core | All Orange, All Orange No Italics |
...
VS Code can follow your OS light/dark mode with `window.autoDetectColorScheme`. See [Auto-Switching Themes](docs/auto-switching.md) for ready-to-use settings pairs and seasonal rotation ideas.
